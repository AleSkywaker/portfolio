...
Welcome to my [personal website](https://alexsandrocolombo.com)! This is an [MIT licensed](https://github.com/AleSkywaker/portfolio/blob/main/LICENSE) React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
...
1. Clone the repository:
   ...
   ```bash
   git clone git://github.com/AleSkywaker/portfolio.git
   cd personal-site
   ```
